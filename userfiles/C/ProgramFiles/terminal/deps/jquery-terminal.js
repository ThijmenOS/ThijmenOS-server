    ...
    format: function i(e, t) {
      ...
      function i(e, t, n, r, i, u, a) {
        ...
        if ($.terminal.valid_color(n)) {
          $.extend(p, { color: n, "--color": n, "--original-color": n });
          if (t.indexOf("!") !== -1) {
            p["--link-color"] = n;
          }
          if (t.indexOf("g") !== -1) {
  ...
  $.fn.terminal = function (e, t) {
    ...
    function s(t, a, n) {
      ...
      if (e === "array") {
        ...
        n({ interpreter: V(t, F.checkArity, a), completion: Object.keys(t) });
      } else {
        if (e === "undefined") {
          t = $.noop;
        } else if (e !== "function") {
              ...
              for (n = requests.length; n--; ) {
                ...
                if (r.readyState !== 4) {
                  try {
                    ...
                    if (is_function(F.exceptionHandler)) {
                      F.exceptionHandler.call(g, t, "AJAX ABORT");
                    } else {
    ...
    var Ie = $.omap(
      {
          ...
          g.push(
            function (n) {
              g.set_mask(F.maskChar).push(
                function (e) {
                  try {
                    if (v("onBeforeLogin", [n, e]) === false) {
                      s();
                      return;
                    }
                    g.pause();
                    var t = r.call(g, n, e, function (e, t) {
                      i(n, e, t);
                    });
                    unpromise(
                      t,
        ...
        refresh: function () {
          if (z.width !== 0) {
            css(g[0], { "--char-width": z.width, "--pixel-density": I });
          }
          g.clear_cache();
          if (He) {
            S.resize();
          ...
          b(function e() {
            try {
              ...
              if (l.length === 0) {
                ...
                css(S[0], { top: -i.height / I + "px", "--prompt-offset": c });
              ...
              if (is_function(F.exceptionHandler)) {
                try {
                  F.exceptionHandler.call(g, e, "TERMINAL (Flush)");
                } catch (e) {
          ...
          function n(i) {
            try {
              ...
              if (a.typing) {
                ...
                if (typeof a.delay !== "number" || isNaN(a.delay)) {
                  return o.reject(
              ...
              unpromise(
                ...
                function (e) {
                  ...
                  var r = re({ value: e, options: a, index: t });
                  if (is_promise(r)) {
                    Pe = true;
                  }
                  E.push([e, a]);
              ...
              if (is_function(F.exceptionHandler)) {
                F.exceptionHandler.call(g, e, "TERMINAL (echo)");
              } else {
            ...
            s(a, o.login, function (e) {
              ...
              if (r.login) {
                ...
                if (n === "function") {
                  ...
                  t = r.infiniteLogin ? $.noop : g.pop;
                  g.login(Z(a, r.login), r.infiniteLogin, u, t);
                }
              } else {
                u();
              }
    ...
    y = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(O);
    g.addClass("terminal");
    var I = ft();
    ...
    s(e, F.login, function (e) {
      ...
      if (is_mobile) {
        ...
        r.on("focus.terminal_" + g.id(), lt).on("blur.terminal_" + g.id(), ct);
        var h;
        (function () {
          var t = 0;
          var n;
      ...
      function s() {
        if (window.IntersectionObserver) {
          var e = $('<div class="terminal-scroll-marker"/>').appendTo(j);
          var t = e;
          if (F.scrollBottomOffset !== -1) {
