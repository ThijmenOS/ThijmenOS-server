...
(function (r, i) {
  ...
  $.fn.terminal = function (e, t) {
      ...
      return function (e, t) {
        ...
        if (i === "function") {
          if (o && r.length !== n.args.length) {
            g.error(
              "&#91;Arity&#93; " +
                sprintf(p().wrongArity, n.name, r.length, n.args.length)
            );
          } else {
            ...
            if ($.isPlainObject(i) && typeof i.name === "string") {
              t[i.name] = function () {
                ...
                if (C.checkArity && i.params && i.params.length !== n) {
                  g.error(
                    "&#91;Arity&#93; " +
                      sprintf(p().wrongArity, i.name, i.params.length, n)
                  );
                } else {
                  g.pause(C.softPause);
                  if (e) {
    ...
    function me(n, e, t) {
      ...
      function o(e) {
        return is_function(e.done || e.then) && Je;
      }
      function s() {
      ...
      g.push(
        function (i) {
          g.set_mask(C.maskChar).push(
            ...
            { prompt: p().password + ": ", name: "password" }
          );
        },
    ...
    if (g.is("body,html")) {
      if (g.hasClass("full-screen-terminal")) {
        var ze = g.find("> .terminal").data("terminal");
        if (ze) {
          return ze;
        }
      }
    ...
    var Pe = $.omap(
      {
        ...
        geometry: function () {
          var t = window.getComputedStyle(S[0]);
          function e(e) {
        ...
        destroy: function () {
          f(function e() {
            ...
            at.resizer("unbind").remove();
            ot.resizer("unbind").remove();
            ...
            $(window).off("blur", mt).off("focus", ct);
    ...
    $.extend(g, Pe);
    if (g.length === 0) {
      var Ne = sprintf(p().invalidSelector);
      throw new $.terminal.Exception(Ne);
    }
    g.data("terminal", g);
    var a = [];
    var Me = false;
    ...
    if (typeof e === "string") {
      ...
      for (var I = 0, ft = e.length; I < ft; ++I) {
    ...
    if (is_function(C.login)) {
      z = C.login;
    } else if (lt && (typeof C.login === "string" || C.login === true)) {
      z = X(lt, C.login);
    }
    terminals.append(g);
    function ct() {
    ...
    function pt() {
      var e = ot[0].getBoundingClientRect();
      return e.width || 1;
    }
    function mt() {
      it = E;
    ...
    $(document).on("paste.terminal_" + g.id(), ht);
    var P = $.extend(
      {},
      Ee,
    ...
    G(e, C.login, function (e) {
      ...
      if (is_mobile) {
        ...
        r.on("focus.terminal_" + g.id(), ct).on("blur.terminal_" + g.id(), mt);
        var h;
        (function () {
          var t = 0;
          var n;
      ...
      function a() {
        ...
        at.resizer("unbind").resizer(function () {
          i();
          g.resize();
        }, e);
        ot.resizer("unbind").resizer(function () {
          O = pt();
          g.resize();
        }, e);
      }
      function o(e) {
        Ve = e[0].intersectionRatio === 1;
      }
      function s() {
      ...
      if (c) {
        ...
        ut.observe(document.body, { childList: true });
      }
      if (f) {
        l();
      }
